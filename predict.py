...
# 修改后的网络
from pspnet_Mobile.net_conv5.pspnet import mobilenet_pspnet
...
if __name__ == "__main__":
    ...
    #   下面只是一个示例
    # --------------------------------------------------#
    # heavy ep252-loss0.015-val_loss0.026.h5
    model.load_weights(
        r"D:\Github\yuyifenge\Semantic-Segmentation-master\pspnet_Mobile\logss\net_conv5\night_light/ep284-loss0.026-val_loss0.044.h5")

    # 打开文件夹 验证集
    image_ids = open(
        r"D:\Github\yuyifenge\Semantic-Segmentation-master\deeplab_Mobile\dataset2\datasets\aug_night_light\val.txt",
        'r').read().splitlines()
    # --------------------------------------------------#
    #   对imgs文件夹进行一个遍历
    # --------------------------------------------------#
    ...
    for image_id in tqdm(image_ids):
        ...
        #   打开imgs文件夹里面的每一个图片
        # --------------------------------------------------#
        image_path = r"D:\Github\yuyifenge\Semantic-Segmentation-master\deeplab_Mobile\dataset2\datasets\aug_night_light\jpg/" + image_id + ".jpg"
        ...
        seg_img.save(r"D:\Github\yuyifenge\Semantic-Segmentation-master\pspnet_Mobile\img/" + image_id + '.png')
